...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            @include('Admin.header.adding.addUser_header')
            <!-- /.content-header -->
            <!-- Main row -->
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <input type="email" class="form-control" value="{{ old('email') }}"
                                            id="email" name="email" placeholder="ایمیل را وارد کنید">
                                        @error('email')
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('first_name') }}"
                                            id="first_name" name="first_name" placeholder="نام">
                                        @error('first_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('last_name') }}"
                                            id="last_name" name="last_name" placeholder="نام خانوادگی">
                                        @error('last_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            @if (isset($_GET['role'])) value="{{ $_GET['role'] }}" @endif id="role" name="role"
                                                placeholder="نقش">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('user_name') }}"
                                                id="user_name" name="user_name" placeholder="نام کاربری">
                                            @error('user_name')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select class="form-control" value="{{ old('gender') }}" id="gender"
                                                name="gender">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('country') }}"
                                                id="country" name="country" placeholder="کشور خود را وارد کنید">
                                            @error('country')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('province') }}"
                                                id="province" name="province" placeholder="استان خود را وارد کنید">
                                            @error('province')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('city') }}"
                                                id="city" name="city" placeholder="شهر خود را وارد کنید">
                                            @error('city')
                                                <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('address') }}"
                                        id="address" name="address" placeholder="آدرس را وارد کنید">
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input class="form-control @error('password') is-invalid @enderror"
                                                id="password" name="password" type="password" pattern="^\S{6,}$"
