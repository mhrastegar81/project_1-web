...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        @include('Buyer.header.data.checksData_header')
        <!-- Main content -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div id="accordionHead">
                                <form role="form" method="get" action="{{ route('buyer.factor.index') }}">
                                    <div class="card">
                                        ...
                                        <div class="collapse" id="fillters" data-bs-parent="#accordionHead">
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <a href="{{ route('buyer.factor.index') }}">
                            ...
                            <table id="Data" class="table table-bordered table-striped">
                                ...
                                @foreach ($checks as $check)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('buyer.factor.destroy',['id'=>$check->id])}}"
                                                  method="post">
                                                @csrf
                                        ...
                                        <td>
                                            <form action="{{route('buyer.factor.update_status',['id'=>$check->id])}}"
                                                  method="post">
                                                @csrf
